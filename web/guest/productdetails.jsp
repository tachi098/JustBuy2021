<%-- 
    ...
    Created on : Apr 26, 2021, 2:10:12 PM
    Author     : Natsu
--%>
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active" data-interval="10000">
                                <img src="${pageContext.request.contextPath}/${productDetails.image}" class="d-block w-40 card-img-top" alt="..." style="height: auto; width: 300px"/>
                            </div>
                    ...
                    <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                ...
                                %>
                                <a href="GuestLoginController?view=login" style="color: white" class="btn btn-primary buy">ADD TO CART</a>
                                <%
                                    }
                                %>
